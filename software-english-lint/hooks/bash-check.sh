...
# subcommand, since a PR description matters whichever one sets it).
...
echo "$OUTPUT" >&2
echo "" >&2
echo "Software English violations found in the commit/PR text. Fix the text, then run the command again." >&2
exit 2
